  ...
  */
  ResponsiveTabs.prototype.init = function () {
    ...
    this.$element.bind('tabs-activate', function(e, oTab) {          
      ...
      var objTabLink = oTab.tab.find("a");
      var objAccLink = oTab.accordionTab.find("a");
      
      objTabLink.attr("aria-selected", true);
      objAccLink.attr("aria-selected", true);
    ...
    this.$element.bind('tabs-deactivate', function(e, oTab) {
      ...
      objTabLink.attr("aria-selected", false);
      objAccLink.attr("aria-selected", false);
